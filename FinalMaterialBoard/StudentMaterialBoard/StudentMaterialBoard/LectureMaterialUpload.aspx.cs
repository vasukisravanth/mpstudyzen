...
{
    public partial class LectureMaterialUpload : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (MaterialFile.HasFile)
            {
                ...
                string res = obj.UploadMaterials(Session["UserId"].ToString(), int.Parse(ddlSubject.SelectedItem.Value), "Lecture", txtName.Text, txtDescription.Text, filepath);
                if (res == "1")
                {
                    txtName.Text = "";
                    txtDescription.Text = "";
