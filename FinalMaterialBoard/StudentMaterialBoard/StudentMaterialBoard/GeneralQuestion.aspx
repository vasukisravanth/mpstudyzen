<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="GeneralQuestion.aspx.cs" Inherits="StudentMaterialBoard.GeneralQuestion" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    General Question Discussion</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                                        ...
                                                        <div class="forum-item active">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <br />
                                                                    <div class="forum-sub-title">
                                                                        <asp:LinkButton ID="lnkViewReply" runat="server" class="btn btn-primary" CommandArgument='<%# Eval("GQId") %>'
                                                                            OnClick="lnkViewReply_Click"><i class="glyphicon glyphicon-comment"></i>&nbsp View Reply</asp:LinkButton>
                                                                        <asp:LinkButton ID="lnkPostReply" runat="server" class="btn btn-warning" CommandArgument='<%# Eval("GQId") %>'
                                                            ...
                                                            <div class="forum-item active">
                                                                <div class="row">
                                                                    <div class="col-md-9">
                                                                        ...
                                                                        <asp:Label ID="Label2" Style="font-size: 20px;" class="forum-item-title" runat="server"
                                                                            Text='<%# Eval("QuestionReply") %>'></asp:Label>
                                                                        <div class="forum-sub-title">
                                                                            Posted By:<asp:Label ID="Label3" runat="server" Text='<%# Eval("UserType") %>'></asp:Label>
